                    ...
                    <div class="navbar-header">
                        ...
                        <div class="lgx-logo">
                            <a href="index.html" class="lgx-scroll">
                                <img src="{{ asset('fe/assets/img/newinnov8.png') }}" alt="Emeet Logo"
                                    class="main-logo" />
                            </a>
                        </div>
                    </div>
                    <div id="navbar" class="navbar-collapse collapse">
                        <div class="lgx-nav-right navbar-right">
                            <div class="lgx-cart-area">
                                <a class="lgx-btn lgx-btn-red" href="register.html">Register</a>
                            </div>
                        </div>
                        <ul class="nav navbar-nav lgx-nav navbar-right">
                            ...
                            <li><a class="lgx-scroll" href="#lgx-sponsors">Partners</a></li>
                            <li><a class="lgx-scroll" href="#lgx-photo-gallery">News</a></li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
                </nav>
